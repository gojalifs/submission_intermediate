...
import com.satria.dicoding.latihan.storyapp_submission.view.new_story.NewStoryViewModel

class NewStoryViewModelFactory private constructor(private val storyRepository: StoryRepository) :
    ...
    companion object {
        ...
        fun getInstance(context: Context): NewStoryViewModelFactory = instance ?: synchronized(this) {
            instance ?: NewStoryViewModelFactory(Injection.provideStoryRepository(context))
        }.also { instance = it }
    }
}